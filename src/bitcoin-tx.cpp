...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xeyra-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xeyra-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xeyra transaction") + "\n" +
              "  xeyra-tx [options] -create [commands]   " + _("Create hex-encoded xeyra transaction") + "\n" +
              "\n";
