...
const char * const BITCOIN_CONF_FILENAME = "xeyra.conf";
const char * const BITCOIN_PID_FILENAME = "xeyra.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "XEYRA";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/XEYRA";
#else
    // Unix
    return pathRet / ".xeyra";
#endif
#endif
}
